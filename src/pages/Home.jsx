        ...
        <Container className='relative pt-20 pb-16 text-center lg:pt-32'>
            ...
            <h1 className='max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl'>
                ...
                <span className='relative text-green-600 whitespace-nowrap'>
                    ...
                    <span className='relative'>React + Python</span>
                </span>{' '}
                Visualizer
            </h1>
            <p className='max-w-xl mx-auto mt-6 text-lg tracking-tight text-slate-700'>
                Cada página del informe muestra preguntas de interés sobre las instituciones de educación superior en Colomba (IES)
                El dataset utilizado es reportado por el Ministerio de Educación Nacional (MEN)
                La información mostrada corresponde al periodo comprendido entre los años 2016-2019
            </p>
            <div className='flex justify-center mt-10 gap-x-6'>
                <Button href='/dashboard' icon={BeakerIcon} variant='secondary' color='green'>See data</Button>
            </div>
        </Container>
